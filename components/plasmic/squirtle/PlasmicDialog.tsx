...
import projectcss from "../website_starter/plasmic.module.css"; // plasmic-import: 61gETVAv9Y5XUyzBBiKaE2/projectcss
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 1DFDKTDshbFk/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: hhA2UNOJBooY/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: SGHhp3IATlZa/icon
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_Mi1IpFFjcnLj"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__vE9Ez)}
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__s2T0J)}
                  displayHeight={"auto"}
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__vMFwc)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
